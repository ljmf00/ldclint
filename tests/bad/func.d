// RUN: env LDCLINT_FLAGS="-Watproperty" ldc2 -wi -c %s -o- --plugin=%PLUGIN% 2>&1 | FileCheck %s
...
// CHECK-DAG: func.d(19): Warning: Empty declaration
};

// CHECK-DAG: func.d(22): Warning: Variable `globalFoobar` appears to be unused
